...
def go(bigram_tokens, max_token_num, model_path, orig_activations, orig_pcas, orig_logits, pca_dim, pertubation_func, pertubation_size, perturbation_loc, name):
    ...
    save_path = f"/om2/user/jackking/transformer_xray/data/{perturbation_loc}/perturb_{pertubation_size}/{name}"
    ...
    bigram_results_df = pd.read_csv('/om2/user/jackking/transformer_xray/dynamics/bigram_results.csv', index_col=0)
